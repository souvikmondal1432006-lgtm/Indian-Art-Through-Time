...
export default function ArtifactModal({
  ...
  return (
    <>
      ...
      >
        <div className="bg-[#FAF6EF] w-full max-w-5xl rounded-sm shadow-modal border border-gold/40 overflow-hidden flex flex-col max-h-[92vh]">
          ...
          <div className="flex items-center justify-between px-6 py-3.5 bg-[#1C1917] text-ivory border-b border-gold/30">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center bg-white/10 rounded-sm border border-white/10">
                <button
                  onClick={onPrev}
                  className="px-2.5 py-1 text-xs font-body text-ivory hover:text-gold hover:bg-white/10 transition-colors flex items-center gap-1"
              ...
              <button
                ...
                className="p-1.5 text-ivory/80 hover:text-white hover:bg-white/10 rounded-sm transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          {/* Modal Main Body: Left Image & Right Editorial Label */}
          <div className="flex-1 overflow-y-auto grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-[#E7DEC8]">
            ...
            <div className="md:col-span-6 bg-[#161311] p-6 flex flex-col justify-between relative group">
              ...
              <div
                ...
                className="relative flex-1 min-h-[300px] flex items-center justify-center overflow-hidden rounded-sm cursor-zoom-in border border-gold/20 bg-black/40"
              >
                <ImageWithFallback
                  src={artifact.image}
                ...
                <div className="absolute bottom-3 right-3 bg-[#1C1917]/90 text-ivory text-xs font-body px-3 py-1.5 rounded-sm border border-gold/40 flex items-center gap-1.5 opacity-90 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
            ...
            {/* ============================================================ */}
            {/* RIGHT: Curatorial Museum Label & Detailed Story              */}
            {/* ============================================================ */}
            <div className="md:col-span-6 p-6 md:p-8 overflow-y-auto space-y-6">
              {/* Header: Number, Title, Date, Period */}
              <div>
                <span className="font-display font-semibold text-sm text-terracotta tracking-widest block mb-1">
                  NO. {artifact.catalogNumber}
                </span>
                <h2
                  id="artifact-modal-title"
                  className="font-display font-medium text-2xl sm:text-3xl text-charcoal leading-tight"
                >
                  {artifact.name}
                </h2>
                <div className="mt-2 flex items-center gap-3 text-sm font-body">
                  <span className="font-semibold text-terracotta">{artifact.dateRange}</span>
                  <span className="text-charcoal/30">·</span>
                  <span className="text-charcoal-soft">{period?.name}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-y-3.5 gap-x-4 text-xs font-body">
                <div>
                ...
                <div>
                  ...
                  <span className="text-charcoal font-medium">{artifact.artForm} ({artifact.traditionTrack})</span>
                </div>
              ...
              {/* Why It Matters */}
              <div className="bg-[#F3ECE0] border-l-2 border-terracotta p-3.5 rounded-sm">
              ...
              {/* Did You Know? */}
              <div className="bg-[#FAF2E3] border border-gold/30 p-3.5 rounded-sm">
              ...
              <div className="pt-2 border-t border-[#E5DAC8] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs font-body text-charcoal-muted">
                <div>
                  <span className="uppercase tracking-widest text-[10px] block font-medium">Institutional Source</span>
